...
while(ds_list_size(openSet) > 0)
{
    ...
    for (var i=0;i<ds_list_size(openSet);++i)
    {
		...
		show_debug_message("controller: " + string(instance_find(obj_jump_test_controller,0)));
