...
else if(formation_selection == 3)
{
	with(template_hero)
	{
		if(current_formation == Formation.follow)
		{			
			current_formation = Formation.coordinated;		
		}
	}
	show_debug_message("\n---------------- \n" +"Player link " + string(id) + " calls coordinated formation with child_link: " + string(child_link));
	current_formation = Formation.coordinated;
	setting_path = true;
}
else 
