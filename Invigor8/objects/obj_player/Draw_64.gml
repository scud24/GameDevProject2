...
else if(current_formation = Formation.switch_prep)
{
	...
	selection_angle_offset = (formation_selection * angle_step) - (substeps_remaining * angle_substep);
