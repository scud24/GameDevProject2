...
else if(current_formation = Formation.switch_prep)
{
	...
	draw_text_transformed(x+xoffset+120*dcos(selection_angle_offset+(3*angle_step)),y+yoffset+120*dsin(selection_angle_offset+(3*angle_step)), "Coordinated",1.0, 1.0, 0);
	draw_text_transformed(x+xoffset+120*dcos(selection_angle_offset+(4*angle_step)),y+yoffset+120*dsin(selection_angle_offset+(4*angle_step)), "Tower", 1.0, 1.0, 0);
