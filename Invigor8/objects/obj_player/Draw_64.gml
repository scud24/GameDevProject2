...
{
	var xoffset = 32-camera_get_view_x(view_camera[0]);
	var yoffset = 16-camera_get_view_y(view_camera[0]);
	...
	draw_set_alpha(1);
	draw_sprite(spr_formation_select_mask,0, x+xoffset,obj_player.y+yoffset);
	gpu_set_blendenable(true);
	gpu_set_colorwriteenable(true,true,true,true);
	gpu_set_blendmode_ext(bm_dest_alpha,bm_inv_dest_alpha);
	gpu_set_alphatestenable(true);
	draw_sprite(spr_formation_text1,0, obj_player.x+xoffset,obj_player.y+yoffset);
	...
	draw_text_transformed(x+xoffset+120*dcos(selection_angle_offset-(3*angle_step)),y+yoffset+120*dsin(selection_angle_offset-(3*angle_step)), "Tower", 1.0, 1.0, 0);
