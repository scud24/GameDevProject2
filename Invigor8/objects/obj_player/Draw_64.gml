...
if(current_formation=Formation.swap_lead)
{
	...
	draw_sprite_ext(selected_character.sprite_index,selected_character.image_index, selected_character.x, selected_character.y-yoffset_sprite, 1.1, 1.1,0,c_yellow, 255);
}