...
if(current_formation == Formation.switch_prep)
{
	...
	if(keyboard_check_pressed(vk_up))
	{
		...
		if(formation_selection<0)
		{
			...
			angle_substep = (angle_step*2 - (formation_selection*angle_step))/num_angle_substeps;
		}
	}
