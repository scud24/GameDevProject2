...
if(current_formation == Formation.assemble)
{
	...
	if(isGrounded && jump_started)
	{
		...
		jump_target = jump_target.parent;
...
{
	randomize();
	startNode = instance_find(obj_path_node,5);
	endNode = instance_find(obj_path_node,1);
