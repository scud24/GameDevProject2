...
if( !fetch ){
	...
	draw_sprite(spr_diagbox_temp, 0, x_pos, y_pos);
	...
	if(dialogue_avatar != ""){
		if(dialogue_leftSide) {
			...
			draw_sprite_ext(dialogue_avatar, 0, x_pos + 247 , y_pos + 4, -1 , 1, 0, c_white, 1);
		}
	}
