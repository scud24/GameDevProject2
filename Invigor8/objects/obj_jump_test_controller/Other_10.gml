...
jump_target = other;
show_debug_message("Set controller jump target to: " + string(jump_target));
with(obj_test_jumper)
{
	jump_target = other.jump_target;
	show_debug_message("Set jumper jump target to: " + string(jump_target));
