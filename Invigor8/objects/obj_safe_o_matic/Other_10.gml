...
/// @DnDVersion : 1
/// @DnDHash : 772F70D2
/// @DnDArgument : "code" "for(var i = 0; i < obj_roomController.downed_units; i++)$(13_10){$(13_10)	with(obj_player)$(13_10)	{$(13_10)		show_debug_message("Safe-o-matic attempts to spawn character");$(13_10)		new_link = instance_create_layer(x,y,"Instances", next_link_object);$(13_10)		scr_addEndLink(new_link);$(13_10)		obj_roomController.downed_units--;$(13_10)	}$(13_10)}"
